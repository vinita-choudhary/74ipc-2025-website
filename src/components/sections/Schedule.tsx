...
const Schedule = () => {
  ...
  const getTypeColor = (type: string) => {
    const colors = {
      keynote: 'bg-yellow-100 text-yellow-800 border-yellow-200',
      ...
      general: 'bg-pharmaceutical-100 text-pharmaceutical-800 border-pharmaceutical-200'
    }
    return colors[type as keyof typeof colors] || colors.general
  }

  const filteredSchedule = scheduleData[selectedDay as keyof typeof scheduleData].filter(
    item => selectedTrack === 'all' || item.track === selectedTrack || item.track === 'general'
  )
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            Explore our comprehensive 3-day program featuring keynotes, panels, workshops, and networking opportunities.
          </p>
        </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 mb-3">
                      ...
                      <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium border ${getTypeColor(item.type)}`}>
                    ...
                    <div className="grid sm:grid-cols-3 gap-4 text-sm text-gray-600">
                      {item.speaker && (
                        <div className="flex items-center">
                          ...
                          <span><strong>Speaker:</strong> {item.speaker}</span>
                        </div>
                      )}
                      <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        <Users className="w-4 h-4 mr-2 text-pharmaceutical-500" />
                        <span><strong>Capacity:</strong> {item.attendees}</span>
                      </div>
                    </div>
                  </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gray-50 rounded-2xl p-8 inline-block">
            ...
            <p className="text-gray-600 mb-6">
              Download the detailed program with session abstracts and speaker information.
            </p>
